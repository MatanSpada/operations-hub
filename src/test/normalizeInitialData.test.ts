...
describe("normalizeInitialData", () => {
  it("normalizes Apps Script sheet rows into the frontend contract", () => {
    const data = normalizeInitialData({
      ...
      campTasks: [{ ID: "ct1", Date: "11/03/26", Department: "Operations", RequesterName: "Dana", ApprovingCommander: "Major Tal", Mission: "Camp inspection", TreatmentSummary: "Completed" }],
    ...
    expect(data.campTasks[0].date).toBe("2026-03-11");
